 ...
 <!-- Contact form JS-->
 <script src="<?= get_template_directory_uri(); ?>/assets/mail/jqBootstrapValidation.js"></script>
 <script src="<?= get_template_directory_uri(); ?>/assets/mail/contact_me.js"></script>
 <!-- Core theme JS-->
